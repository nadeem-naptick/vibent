...
export default function HomePage() {
  ...
  const handleSubmit = async (selectedResult?: SearchResult) => {
    ...
    // Continue with existing search/clone workflow
    if (!inputValue) {
  ...
  // Perform search when user types - load first 5 results
  ...
  const loadMoreResults = async () => {
    if (!currentSearchQuery || isLoadingMore) return;
              ...
              <div className="rounded-20 -mt-30 lg:-mt-30">
                ...
                <div className="p-16 flex gap-12 items-center w-full relative bg-white rounded-20">
                  ...
                  {hasSearched && searchResults.length > 0 && !isFadingOut ? (
                    ...
                    <>
                      {isURL(url) ? (
                        // Clone icon for URLs in Page Mode
                        <svg 
                          width="20" 
                          height="20" 
                          viewBox="0 0 20 20" 
                        ...
                        // AI generation icon for prompts in Page Mode
                        <svg 
                          width="20" 
                          height="20" 
                          viewBox="0 0 20 20" 
            ...
            {isSearching ? (
              ...
              <div className="relative">
                <div className="relative h-[250px] overflow-hidden">
                  ...
                  <div className="carousel-container absolute left-0 flex gap-12 py-4">
                    {/* Show results without duplication for now since we're loading incrementally */}
                ...
                {hasMoreResults && (
                  <div className="mt-6 text-center">
                    ...
                    <button
                      ...
                      className="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 mx-auto"
                    >
                      {isLoadingMore ? (
                        <>
